...
GO
/*Phase 4 --Part A
Create an Insert/Update where transactions are used updating data separately in two tables*/
BEGIN TRANSACTION
INSERT INTO Customer (
	CustName
,	CustAddress
...
/*Phase 4 --Part B
Create a SQL user*/
CREATE LOGIN GnometrudeWilliams WITH PASSWORD = 'strokeththebeard';
CREATE USER GnometrudeWilliams FOR LOGIN GnometrudeWilliams;
GO
/*Phase 4 --Part C
Give a user access to a database*/
GRANT SELECT ON Manufacturer TO GnometrudeWilliams;
GRANT SELECT ON ProductType TO GnometrudeWilliams;
GRANT SELECT ON Manufacturer_makes_ProductType TO GnometrudeWilliams;
GRANT SELECT ON Product TO GnometrudeWilliams;
GRANT SELECT ON Customer TO GnometrudeWilliams;
GRANT SELECT ON Review TO GnometrudeWilliams;
GRANT SELECT ON OrderInfo TO GnometrudeWilliams;
GRANT SELECT ON Order_has_Products TO GnometrudeWilliams;
GO
/*Phase 4 --Part D
Grant a user access to execute a stored procedure*/
GRANT EXECUTE ON OBJECT::insertIntoManufactuer
    TO GnometrudeWilliams;
GO
/*Phase 4 --Part E
Revoke a users rights to a table*/
REVOKE SELECT ON Manufacturer TO GnometrudeWilliams;
GO
/*Phase 4 --Part F
Deny a user access to a table*/
DENY SELECT ON OBJECT::Customer TO GnometrudeWilliams;
GO
/*Removes Database and Users created
DROP USER GnometrudeWilliams;
DROP LOGIN GnometrudeWilliams;
USE master;
